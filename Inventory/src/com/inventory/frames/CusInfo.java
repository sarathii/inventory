	...
	public void table()
	{
		...
		session.beginTransaction();
		 //Query query = session.createQuery("from CustomerModel");
		  //List<CustomerModel> customer = session.createQuery("from Custom").list();
...
//						CustomerForm customerForm=new CustomerForm();
	//					customerForm.main(null);
		...
		//	String s=customerForm.code.setText(model.getValueAt(index, 0).toString()));
			...
			System.out.print("felll");
			String code= model.getValueAt(index, 0).toString();
			String name= model.getValueAt(index, 1).toString();
			String adress= model.getValueAt(index, 2).toString();
			String city= model.getValueAt(index, 3).toString();
			String contact= model.getValueAt(index, 4).toString();
			String delivered= model.getValueAt(index, 5).toString();
			String designation= model.getValueAt(index, 6).toString();
